...
import findRoute, {
  getUrlQuery,
} from '/Users/hoang-danhnguyen/Documents/kltn/fca_frontend/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3001,
      path: '/Users/hoang-danhnguyen/Documents/kltn/fca_frontend',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
